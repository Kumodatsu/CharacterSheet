...
CS.Core.Locale.add_translation_table("enUS", {
  ...
  CMD_DESC_STATS             = [['/cs stats' displays your stats in the chat.]],
  CMD_DESC_REMOVE_RESOURCE   = [['/cs remove-resource <name>' removes the custom resource with the given name.]],
  CMD_DESC_SET_RESOURCE      = [['/cs set-resource <name> <value>' sets the custom resource with the given name to the given value.]],
  CMD_DESC_ADD_RESOURCE      = [['/cs add-resource <name> <min> <max>' adds a resource with the given name and minimum and maximum value.]],
